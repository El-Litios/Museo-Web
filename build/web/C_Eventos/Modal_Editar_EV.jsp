            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control text-center" name="gal" style="border: none;" value="gal" id="gal" style="border: none;" readonly/>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="Servlet_Evento?op=3">
                        <!--Codigo y Nombre-->
                        <div class="row form-group">
