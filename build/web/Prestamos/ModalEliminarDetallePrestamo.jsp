<!--eliminar detalle de prestamos-->
<div class="modal fade"  id="eliminardetalleprestamo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="ModalLabel1">Borrar Detalle</h4></center>
            </div>
            <div class="modal-body">
                <p class="text-center">Seguro de Eliminar el Registro?</p>
                <form method="POST" action="Servlet_Prestamos?op=9">
...
<script>
    $(document).ready(function (e){
            $('#eliminardetalleprestamo').on('show.bs.modal',function(e){
