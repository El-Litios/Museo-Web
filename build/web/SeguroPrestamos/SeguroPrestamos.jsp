...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-4">
                <h2><i class="fa fa-images"></i> SEGUROS DE PRESTAMOS</h2><hr>
            </div>
            <div class="col-md-6">
            </div>
            <div class="col-md-2">
    ...
    <div class="panel-info">
        ...
        <c:forEach items="${lista}" var="fila">
            <tr>
                ...
                <td>
                    <a href="Servlet_SeguroPrestamos?op=5&codigo=${fila.cod_seguro}" 
                ...
                <td style="text-align: center;"><a href="#editar" data-id="<c:out value="${fila.cod_seguro}"/>" 
                       ...
                       <jsp:include page="Modal_Editar_SP.jsp"/>
                ...
                <%if(((String)session.getAttribute("rol")).equals("Administrador")){%>
                    <td style="text-align: center;"><a href="#eliminar" data-id="<c:out value="${fila.cod_seguro}"/>" 
                       ...
                       <jsp:include page="Modal_Eliminar_SP.jsp"/>
            </tr>
        </c:forEach>
        </tbody>
    </table>
...
<jsp:include page="Modal_Agregar_SP.jsp"/>
