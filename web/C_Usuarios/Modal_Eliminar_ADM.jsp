    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="ModalLabel1">Borrar Administrador</h4></center>
            </div>
            <div class="modal-body">
                <p class="text-center">Seguro de Eliminar el Registro?</p>
                <input type="text" class="form-control text-center" name="em" style="border: none;" value="em" id="em" style="border: none;"/>
                <input type="text" class="form-control text-center" name="usu" style="border: none;" value="usu" id="usu" style="border: none;"/>
                <form method="POST" action="Servlet_Administrador?op=4">
