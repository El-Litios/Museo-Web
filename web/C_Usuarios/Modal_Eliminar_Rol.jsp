    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="ModalLabel1">Borrar Rol</h4></center>
            </div>
            <div class="modal-body">
                <p class="text-center">Seguro de Eliminar el Rol?</p>
                <input type="text" class="form-control text-center" name="nombre" style="border: none;" value="nombre" id="nombre" style="border: none;"/>
                <form method="POST" action="Servlet_Rol?op=2">
