<!--eliminar SegurosPrestamos en Prestamos-->
<div class="modal fade"  id="eliminarsegpres" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="Servlet_Prestamos?op=15">
...
<script>
    $(document).ready(function (e){
            $('#eliminarsegpres').on('show.bs.modal',function(e){
