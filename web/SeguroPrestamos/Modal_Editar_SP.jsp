        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="Servlet_SeguroPrestamos?op=3">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="v2" class="form-control" value="" hidden/>
                            </div>
                        </div>   
                        <!--Fecha de Seguro-->
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="v3" class="form-control" value="" hidden/>
                            </div>
                        </div>
                        <!--Monto-->
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="v4" class="form-control" value="" hidden/>
                            </div>
                        </div>
                </div>
            </div>
