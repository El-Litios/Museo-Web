    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="ModalLabel1">Borrar Obra de Arte</h4></center>
            </div>
            <div class="modal-body">
                <p class="text-center">Seguro de Eliminar el Registro?</p>
                <input type="text" class="form-control text-center" name="titulo" style="border: none;" value="titulo" id="titulo" style="border: none;"/>
                <form method="POST" action="Servlet_ObraDeArte?op=4">
