            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control text-center" name="obra" style="border: none;" value="obra" id="obra" style="border: none;" readonly/>
                        </div>
                    </div>
                    <!--Galeria ACTUAL-->
                    <div class="row form-group">
                        <div class="col-sm-2">
                            <label class="control-label" style="position: relative; top: 7px;">Galeria Actual</label>
                        </div>
                        <div class="col-sm-10">
                            <input type="text" class="form-control text-center" name="galeria" style="border: none;" value="galeria" id="galeria" style="border: none;" readonly/>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="Servlet_GaleriasObras?op=3">
                        <!--Codigo y Titulo-->
                        <div class="row form-group">
...
<script>
    $(document).ready(function (e){
            $('#editar').on('show.bs.modal',function(e){
                ...
                $(e.currentTarget).find('#galeria').val(gal);
            })
    });
</script>