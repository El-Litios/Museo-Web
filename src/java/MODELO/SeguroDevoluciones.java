 ...
 * @author Mark-
 */
public class SeguroDevoluciones {
    private int cod_seguro;
    private String desc_seguro;
    private Date fec_seguro;
    private int monto_seguro;

    public SeguroDevoluciones() {
    }

    public SeguroDevoluciones(int cod_seguro, String desc_seguro, Date fec_seguro, int monto_seguro) {
    ...
    public SeguroDevoluciones(int cod_seguro, Date fec_seguro, int monto_seguro) {
        this.cod_seguro = cod_seguro;
        this.fec_seguro = fec_seguro;
        this.monto_seguro = monto_seguro;
    }

    public SeguroDevoluciones(int cod_seguro, String desc_seguro) {
        this.cod_seguro = cod_seguro;
        this.desc_seguro = desc_seguro;
    }
    ...
    public SeguroDevoluciones(Date fec_seguro) {
        this.fec_seguro = fec_seguro;
    }
